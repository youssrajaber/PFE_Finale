<footer class="footer container py-5">
    <div class="row py-4">
        <div class="col-md-5 col-sm-12">
            ...
            <div>
                <p class="grey-color fw-bold py-2">ElectroCity is an online platform that caters to electronics
                    enthusiasts by offering a wide range of electronic products. With a focus on providing a convenient
                    and reliable shopping experience, ElectroCity ensures customer satisfaction and convenience.</p>
            </div>
